...
public class AvaliacaoAMQPConfiguration {
    ...
    public Queue filaDetalhesAvaliacao() {
        return QueueBuilder
                .nonDurable("PAGAMENTOS_DETALHES-AVALIACAO")
                .deadLetterExchange("PAGAMENTOS_DLX")
                .build();
    }
    @Bean
    public Queue avaliacaoDeadLetterQueue() {
        return QueueBuilder
                .nonDurable("PAGAMENTOS_DETALHES-AVALIACAO_DLQ")
                .build();
    }
    ...
    public FanoutExchange deadLetterExchange() {
        return ExchangeBuilder.fanoutExchange("PAGAMENTOS_DLX").build();
    }
